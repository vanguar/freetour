...
class Post(models.Model):
    ...
    month = models.CharField(verbose_name=u'Месяц', max_length=200, db_index=True, blank=True)
    from_to = models.CharField(verbose_name=u'Даты путешествия', max_length=200, db_index=True, blank=True)
    text_1 = models.TextField(verbose_name=u'Текст_1', db_index=True)
    text_2 = models.TextField(verbose_name=u'Текст_2', db_index=True, blank=True)
